            ...
            <div class="card-header border-bottom px-4 py-3">
              <ul :data-group-item="pillsId" class="nav nav-pills nav-tabs-line btn-tab-group" data-group="5">
                <li v-for="(item, index) in buttons" class="nav-item" role="presentation">
                  <button :aria-controls="'course-pills-' + (index + 1)"
                          :aria-selected="index === 0"
                          :class="{active: index === 0}"
                          :data-bs-target="'#course-pills-' + (index + 1)"
                          class="btn-tab-group__btn"
                          data-bs-toggle="pill"
                          role="tab"
                          type="button"
              ...
              <div id="course-pills-tabContent" class="tab-content pt-2">
                  ...
                  <div class="card mb-0 mb-md-4">
                    <div class="row g-0 align-items-center">
                      <div class="col-md-5">
                        ...
                        <img alt="user" class="img-fluid rounded-3" src="/img/me.webp">
                      </div>
                      <div class="col-md-7">
                        ...
                        <div class="card-body">
                          ...
                          <ul class="list-inline mb-3">
                            <li class="list-inline-item me-3">
                              <a class="fs-5 text-twitter" href="#"><i class="fab fa-twitter-square"></i></a>
                            </li>
                            <li class="list-inline-item me-3">
                              <a class="fs-5 text-instagram" href="#"><i class="fab fa-instagram-square"></i></a>
                            </li>
                            <li class="list-inline-item me-3">
                              <a class="fs-5 text-facebook" href="#"><i class="fab fa-facebook-square"></i></a>
                            </li>
                            <li class="list-inline-item me-3">
                              <a class="fs-5 text-linkedin" href="#"><i class="fab fa-linkedin"></i></a>
                            </li>
                            <li class="list-inline-item">
                              <a class="fs-5 text-youtube" href="#"><i class="fab fa-youtube-square"></i></a>
                            </li>
                          </ul>
                    ...
                    <div class="d-md-flex my-4">
                      ...
                      <div>
                        ...
                        <div aria-label="Basic radio toggle button group" class="btn-group" role="group">
                          ...
                          <input id="btnradio1" class="btn-check" name="btnradio" type="radio">
                    ...
                    <div class="d-md-flex my-4">
                      ...
                      <div>
                        ...
                        <div aria-label="Basic radio toggle button group" class="btn-group" role="group">
                          ...
                          <input id="btnradio4" class="btn-check" name="btnradio" type="radio">
                  ...
                  <div class="mt-2">
                    ...
                    <form class="row g-3">
                      ...
                      <div class="col-md-6 bg-light-input">
                        <input id="inputtext" aria-label="First name" class="form-control" placeholder="Name"
                               type="text">
                      </div>

                      <div class="col-md-6 bg-light-input">
                        <input id="inputEmail4" class="form-control" placeholder="Email" type="email">
                      </div>

                      <div class="col-12 bg-light-input">
                        <div aria-autocomplete="list" aria-expanded="false" aria-haspopup="true" class="choices"
                             data-type="select-one" role="combobox" tabindex="0">
                          <div class="choices__inner"><select id="inputState2"
                                                              class="form-select js-choice choices__input"
                                                              data-choice="active"
                                                              hidden="" tabindex="-1">
                            <option data-custom-properties="[object Object]" value="★★★★★ (5/5)">★★★★★ (5/5)</option>
                          </select>
                            <div class="choices__list choices__list--single">
                              <div aria-selected="true" class="choices__item choices__item--selectable"
                          ...
                          <div aria-expanded="false" class="choices__list choices__list--dropdown"><input
                            ...
                            <div class="choices__list" role="listbox">
                              <div id="choices--inputState2-item-choice-1"
                                   ...
                                   data-choice="" data-choice-selectable="" data-id="1"
                                   data-select-text="Press to select" data-value="★★★★★ (5/5)" role="option">
                                ★★★★★ (5/5)
                              </div>
                              <div id="choices--inputState2-item-choice-2"
                                   class="choices__item choices__item--choice choices__item--selectable" data-choice=""
                                   data-choice-selectable="" data-id="2" data-select-text="Press to select"
                                   data-value="★★★★☆ (4/5)" role="option">★★★★☆ (4/5)
                              </div>
                              <div id="choices--inputState2-item-choice-3"
                                   class="choices__item choices__item--choice choices__item--selectable" data-choice=""
                                   data-choice-selectable="" data-id="3" data-select-text="Press to select"
                                   data-value="★★★☆☆ (3/5)" role="option">★★★☆☆ (3/5)
                              </div>
                              <div id="choices--inputState2-item-choice-4"
                                   class="choices__item choices__item--choice choices__item--selectable" data-choice=""
                                   data-choice-selectable="" data-id="4" data-select-text="Press to select"
                                   data-value="★★☆☆☆ (2/5)" role="option">★★☆☆☆ (2/5)
                              </div>
                              <div id="choices--inputState2-item-choice-5"
                                   class="choices__item choices__item--choice choices__item--selectable" data-choice=""
                                   data-choice-selectable="" data-id="5" data-select-text="Press to select"
                                   data-value="★☆☆☆☆ (1/5)" role="option">★☆☆☆☆ (1/5)
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-12 bg-light-input">
                        <textarea id="exampleFormControlTextarea1" class="form-control" placeholder="Your review"
                                  rows="3"></textarea>
                      </div>

                      <div class="col-12">
                        <button class="btn btn-primary mb-0" type="submit">Post Review</button>
                      </div>
                    </form>
                  </div>
                ...
                <div id="course-pills-4" aria-labelledby="course-pills-tab-4" class="tab-pane fade" role="tabpanel">
                  ...
                  <div id="faqAccordion"
                    ...
                    <div v-for="(item, i) in faq" class="accordion-item mb-3">
                      <h6 :id="'heading-' + i" class="accordion-header font-base">
                        <button :aria-controls="'collapse-' + i"
                                :aria-expanded="'true' ? i === 0 : 'false'"
                                :class="{collapsed: i !== 0 }"
                                :data-bs-target="'#collapse-' + i"
                                class="accordion-button fw-bold rounded pe-5"
                ...
                <div id="course-pills-5" aria-labelledby="course-pills-tab-5" class="tab-pane fade" role="tabpanel">
                    ...
                    <div class="col-12">
                      ...
                      <div class="d-flex mb-4">
                        ...
                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                          <a href="#"> <img alt="" class="avatar-img rounded-circle" src="/img/avatar/09.jpg">
                          </a>
                        </div>

                        <form class="w-100 d-flex">
                          <textarea id="autoheighttextarea" class="one form-control pe-4 bg-light"
              ...
              <div class="card shadow p-2 mb-4 z-index-9">
                <div class="overflow-hidden rounded-3">
                  ...
                  <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                    ...
                    <div class="m-auto">
                      <a class="btn btn-lg text-danger btn-round btn-white-shadow mb-0 p-0"
                         data-gallery="course-video" data-glightbox=""
                         href="#">
                ...
                <div class="card-body px-3">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                      ...
                      <a id="dropdownShare" aria-expanded="false" class="btn btn-sm btn-light rounded small"
                ...
                <ul class="list-group list-group-borderless">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span class="h6 fw-light mb-0"><i
                        class="fas fa-fw fa-book-open text-primary"></i>Documentations</span>
                    <span>30</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <span class="h6 fw-light mb-0"><i class="fas fa-fw fa-clock text-primary"></i>Video tutorials</span>
                    <span>4h 50m</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
...
const faq = [
  {
    question: 'What is Webify?',
    answer: 'Webify is a website builder platform that allows anyone to create professional-looking websites without any coding skills.'
  },
  {
    question: 'Do I need any technical skills to use Webify?',
    answer: 'No, Webify is designed for people who don’t have any technical skills or coding knowledge. Its simple drag-and-drop interface allows anyone to create a website in just a few clicks.'
  },
  {
    question: 'Can I customize the design of my website with Webify?',
    answer: 'Yes, Webify includes a variety of pre-built templates and design elements that you can customize to your liking. You can easily change the color scheme, images, and text to make the website reflect your brand.'
  },
  {
    question: 'Does Webify offer SEO optimization for my website?',
    answer: 'Yes, Webify includes built-in SEO optimization features to improve your website’s visibility and rankings on search engines.'
  },
  {
    question: 'Can I sell products or services on my website with Webify?',
    answer: 'Yes, Webify includes e-commerce functionality that allows you to sell products or services online. You can easily set up payment processing and track orders through the platform.'
  },
  {
    question: 'Is Webify mobile-responsive?',
    answer: 'Yes, all websites created with Webify are mobile-responsive, meaning they are optimized to look great on all devices, including smartphones and tablets.'
  },
  {
    question: 'How much does Webify cost?',
    answer: 'Webify offers a subscription-based model, with different tiers based on the number of websites and features needed. Prices start at $10 per month, and there is a free trial available for new users.'
  },
  {
    question: 'Can I cancel my subscription to Webify at any time?',
    answer: 'Yes, you can cancel your subscription to Webify at any time. There are no long-term contracts, and you can keep your website even if you cancel your subscription.'
  },
]
