...
const categories = ['Web Development', 'Mobile Development', 'Desktop Apps', 'Game Dev', 'AI & ML', 'E-Commerce', 'Social Networking', 'Project Management', 'HR & Recruitment', 'Analytics & Data Viz', 'AR & VR', 'Cybersecurity', 'Education & Learning', 'IoT', 'CRM', 'Finance & Accounting', 'Healthcare Apps', 'Marketing & Advertising', 'Finance & Accounting', 'Productivity Tools', 'Content Management'];
...
const project_levels = ['All level', 'Beginner', 'Intermediate', 'Advance']
